...
DEFINE_TEST(Line, Is_KVP)
{
     ...
     Line line_6{R"(vcidflaerw="   ")"};
     VERIFY_ARE_EQUAL(true, line_6.Is_KVP());
     VERIFY_ARE_EQUAL(true, line_6.Is_KVP(&name, &value));
     VERIFY_ARE_EQUAL("vcidflaerw"s, name);
     VERIFY(value.empty());

     Line line_7{R"(vcidflaerw=" 123  ")"};
     VERIFY_ARE_EQUAL(true, line_7.Is_KVP());
     VERIFY_ARE_EQUAL(true, line_7.Is_KVP(&name, &value));
     VERIFY_ARE_EQUAL("vcidflaerw"s, name);
     VERIFY_ARE_EQUAL("123"s, value);

     Line line_8{R"("vcidflaerw"   = 123)"};
     VERIFY_ARE_EQUAL(true, line_8.Is_KVP());
     VERIFY_ARE_EQUAL(true, line_8.Is_KVP(&name, &value));
     VERIFY_ARE_EQUAL("vcidflaerw"s, name);
     VERIFY_ARE_EQUAL("123"s, value);
